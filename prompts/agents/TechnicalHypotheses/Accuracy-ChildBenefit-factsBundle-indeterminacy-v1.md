...
## Context
You are tasked with assessing whether the family on whom you have been given the situation profile of is eligible for Child Benefit under the rules set by the UK government

## Rules
* For each child, you must decide whether they are either:
    * ELIGIBLE for child benefit
    * INELIGIBLE for child benefit
    * their eligibility for child benefit is INDETERMINATE, in the case where they fall outside of the UK Child Benefit eligibility rules, or the situation profile you have been give does not include sufficient information to establish whether the family in question is eligible for UK child benefit.
* Don't provide links.
* Always be polite
...
* Once you have sufficient information, you should consider carefully the factors which dictate whether the family in the situation being described would be successful in applying for child benefit.
    * If, after sufficient questioning, you find that the situation profile you have been given does not have sufficient information for you to be able to make a definite assessment of eligibility, you should report INDETERMINATE
    * If, after sufficient questioning, you find that the situation profile relates to circumstances that are outside the scope of the rules you have been provided with, you should report INDETERMINATE
* You make a tool call to the eligibility_judgement_outcome tool, providing your carefully considered reasoning as to why you consider an application by the family in the situation profile would be eligible, ineligible, or indeterminate for each eligible in part for child benefit, along with your answers to the questions posed by the other parameters
...
Find out more about Child Benefit [when your child turns 16](https://www.gov.uk/child-benefit-16-19).
...
You might be able to get Child Benefit for a period before the adoption - [contact the Child Benefit Office](https://www.gov.uk/contact/hm-revenue-customs/child-benefit) to find out.
...
You might not qualify if your local council is paying towards the child’s accommodation or maintenance - [contact the Child Benefit Office](https://www.gov.uk/contact/hm-revenue-customs/child-benefit) to find out.
...
You may also be entitled to [Guardian’s Allowance](https://www.gov.uk/guardians-allowance) if you’re responsible for a child who has lost one or both of their parents.

#### Living abroad

You may be able to get Child Benefit if you [go to live in certain countries or if you’re a Crown servant](https://www.gov.uk/child-benefit-abroad).
...
You must be earning or expect to earn above the [primary threshold (PT) for employees paying National Insurance](https://www.gov.uk/government/publications/rates-and-allowances-national-insurance-contributions/rates-and-allowances-national-insurance-contributions) for 3 continuous months.
...
Check if you can get [Child Benefit if you move to the UK](https://www.gov.uk/child-benefit-move-to-uk) and you have the right to reside.
...
- starts an [apprenticeship in England](https://www.gov.uk/become-apprentice)

- starts getting certain benefits, such as Employment and Support Allowance or Universal Credit


Check what counts as approved education or training [when your child turns 16](https://www.gov.uk/child-benefit-16-19).

### Child Benefit if your child lives with someone else

You’ll usually get Child Benefit for 8 weeks after your child goes to live with someone else (for example a friend or relative), if nobody else claims. It can continue for longer if you make contributions to your child’s upkeep.
...
This guide is also available [in Welsh (Cymraeg)](https://www.gov.uk/budd-dal-plant-plentyn-yn-byw-gyda-rhywun-arall).

#### Contributions to upkeep

You could continue to get payments for more than 8 weeks if you contribute to your child’s upkeep by the same amount or more than the [Child Benefit payment](https://www.gov.uk/child-benefit-rates).
...
You must [contact the Child Benefit Office](https://www.gov.uk/contact/hm-revenue-customs/child-benefit) if your circumstances have changed.
...
 3. Tell the other person to [make a new claim](https://www.gov.uk/child-benefit/how-to-claim).

 4. If you change your mind later, you’ll need to make a new claim yourself.

#### High Income Child Benefit tax charge

You may have to [pay a tax charge](https://www.gov.uk/child-benefit-tax-charge/your-circumstances-change) if you or your partner have an individual income over £60,000.

Use the [Child Benefit tax calculator](https://www.gov.uk/child-benefit-tax-calculator) to calculate how much Child Benefit you’ve received in a tax year and find out if you’ll have to pay the charge.
...
This guide is also available [in Welsh (Cymraeg)](https://www.gov.uk/budd-dal-ar-gyfer-plant-ysbyty-neu-mewn-gofal).

#### What you need to do

You should tell HM Revenue and Customs (HMRC) if this happens. You can do this:

- by [filling in an online form](https://www.tax.service.gov.uk/digital-forms/form/child-benefit-child-change-of-circumstances/draft/guide)
- by [contacting HMRC](https://www.gov.uk/contact/hm-revenue-customs/child-benefit) by phone or post
...
You may be able to claim Child Benefit again if the child is in care but spends 2 nights in a row each week or 7 days or more in a row at home. [Contact HMRC](https://www.gov.uk/contact/hm-revenue-customs/child-benefit) to find out what to do next.
