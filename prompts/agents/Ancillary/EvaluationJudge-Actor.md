...
* You will be provided with information relating to a situation, you are to assume the role of a user in that situation and engage in dialogue with the agent under test. 
* You will engage in dialogue until the agent under test has related an eligibility outcome to you.
