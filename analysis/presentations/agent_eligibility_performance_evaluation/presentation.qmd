...
1. How well is an agent able to apply a set of eligibility rules when conversing with a user whose situation is described by those rules?
...
> How well is an agent able to apply a set of eligibility rules when conversing with a user whose situation is described by those rules?
