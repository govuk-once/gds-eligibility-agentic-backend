...
- Our final results all used:
    ...
    - an average of results over 6 runs
...
<!-- TODO add commentary on how the results fit into the failure modes -->

# Methodology: Mixed Effects Model

<!-- TODO does it make sense to place this before the preferential failiure mode commentary?  -->
...
- Clear difference in probability density distributions
    - by inspection there appears to be little overlap, suggesting statistical significance
